...
export function parseHTML (html, options) {
    ...
    while (html) {
        ...
        if (!lastTag || !isPlainTextElement(lastTag)) {//非纯文本
    ...
    function parseStartTag () {
        ...
        if (start) {
            ...
            let end, attr
            while (!(end = html.match(startTagClose)) && (attr = html.match(dynamicArgAttribute) || html.match(attribute))) {//有闭合标签 ，且有属性
                attr.start = index
    ...
    function parseEndTag (tagName, start, end) {
        ...
        if (pos >= 0) {
            ...
            /*
            * <div><div><p>sdsd<img/></div>dsds</div>
            *  pos=1
            *  i=2
            * */
